...
<div class="container margin-top">
  <div class="line-middle">
      <div style="background: url('__PUBLICAPP__/images/csbme/totalbg.png') no-repeat bottom right;width: 100%;padding-bottom: 40px;">
           <!--banner pic-->
      <div class="content bannerpic" style="background: url('__PUBLICAPP__/images/csbme/content-burner.png') no-repeat!important;">
          ...
          <div class="content">
              ...
              <div class="left side" style="cursor: pointer; position: static;">
                  <ul class="parent">
                      {loop $alist $vo}
                         <li onclick="gotoUrl({$vo['sort']},{$vo['id']})"><a href="javascript:void(0)">{$vo['title']}</a></li>
                      {/loop}
                  </ul>
              </div>
              <!--左侧导航 end-->
              ...
              <!--  iframe 引用 start-->
              <iframe style="float: right" name="content" id="content" frameborder="0" scrolling="no" width="73%" height="480" src="/index.php?r=default/column/showContent&col={$alistCol}&id={$alistId}" onload="IFrameReSize()" allowtransparency="true"> </iframe>
              <!--  iframe 引用 end-->
              <div class="clear"></div>
          </div>
      </div>
...
<script>
    function gotoUrl(col,id){
          document.getElementById("content").src="/index.php?r=default/column/showContent&col="+col+"&id="+id;
    }
